package com.wallet.payment_management.exception.handler;

import com.wallet.payment_management.dto.response.ErrorResponse;
import com.wallet.payment_management.exception.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleClosedAccountException(
            ClosedAccountException ex, WebRequest request) {
