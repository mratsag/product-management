...
public class WalletAccountController {
    ...
    public ResponseEntity<WalletAccountResponse> createWalletAccount(@Valid @RequestBody WalletAccountRequest request) {
    ...
    public ResponseEntity<PageResponse<WalletAccountResponse>> getWalletAccountsByCustomerId(
        ...
        PageResponse<WalletAccountResponse> response = walletAccountService.getWalletAccountsByCustomerId(customerId, pageable);
